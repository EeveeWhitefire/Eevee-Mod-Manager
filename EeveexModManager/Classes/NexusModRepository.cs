...
namespace EeveexModManager
{
    ...
    public class NexusModRepository : IModRepository
    {
        ...
        public static IModRepository GetRepository(string gameMode)
        {
            return new NexusModRepository(gameMode);
        }
        ...
        public NexusModRepository(string gameMode)
        {
            SetWebsite(gameMode);
            UserAgent = String.Format("Eeveex Client v{0}", "1.0");
            SetFileServerZones();
        ...
        protected void SetFileServerZones()
        {
            ...
            FileServerZones.Add(new FileServerZone("us.p2", "U.S. - Dallas Premium", 2, true));
            FileServerZones.Add(new FileServerZone("us.p1", "U.S. - Washington Premium", 2, true));
            FileServerZones.Add(new FileServerZone("eu.p1", "E.U. - Kent Premium", 1, true));
            ...
            RepositoryFileServerZones.Add(new FileServerZone("us.p2", "U.S. - Dallas Premium", 2, true));
            RepositoryFileServerZones.Add(new FileServerZone("us.p1", "U.S. - Washington Premium", 2, true));
            RepositoryFileServerZones.Add(new FileServerZone("eu.p1", "E.U. - Kent Premium", 1, true));
        }
        ...
        protected void SetWebsite(string gameId)
        {
            switch (gameId)
            {
                case "DragonAge":
                ...
                case "WarThunder":
                    ...
                    break;
                default:
                    throw new Exception("Unsupported game mode: " + gameId);
            }
        }
        ...
        protected string ParseModIdFromFilename(string p_strFilename, out IModInfo p_mifInfo)
        {
            ...
            if ((mifInfo == null) && lstCandidates != null)
            {
        ...
        private IModInfo Convert(NexusModInfo p_nmiNexusModInfo)
        {
            ...
            ModInfo mifInfo = new ModInfo(p_nmiNexusModInfo.Id, p_nmiNexusModInfo.Name, p_nmiNexusModInfo.HumanReadableVersion, p_nmiNexusModInfo.HumanReadableVersion, p_nmiNexusModInfo.IsEndorsed, null, p_nmiNexusModInfo.Author, p_nmiNexusModInfo.CategoryId, -1, p_nmiNexusModInfo.Description, null, uriWebsite);
            return mifInfo;
        }
                ...
                if ((Countries != null) && (Countries.Count > 0))
                {
                    if (p_strUserLocation != "default")
                    {
                        ...
                        if (fszUser != null)
                        {
                            ...
                            booPremium = fszUser.FileServerIsPremium;
                        }
                        else
